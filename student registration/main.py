...
def Save():
    ...
    if N1 == "" or C1 == "Select Class" or D2 == "" or Re1 == "" or S1 == "" or fathername == "" or mothername == "" or F1 == "" or M1 == "":
        ...
        messagebox.showinfo("INFO", "Data entered Sucessfully !!! ")
...
def Update():
    ...
    messagebox.showinfo("UPDATED", "Data Updated Sucessfully!!")
...
# top frames
Label(root, text="Email: abc123xyz@gmail.com ", width=10, height=3, bg="#f0687c", anchor='e').pack(side=TOP, fill=X)
...
srch = Button(root, text="Search", compound=LEFT, width=15, bg="#68ddfa", font="arial 13 bold", command=search)
srch.place(x=1060, y=66)

Update_Button = Button(root, text="Update", bg="#68ddfa", command=Update)
...
# Student Details
obj = LabelFrame(root, text="Student's Detail :", font=20, bd=2, width=900, bg=FRAME_BG, fg=FRAME_FG, height=250,
                 relief=GROOVE)
...
Label(obj, text="Skill :", font="arial 13", bg=FRAME_BG, fg=FRAME_FG).place(x=500, y=150)
...
# Parent Details
obj1 = LabelFrame(root, text="Parent's Detail :", font=20, bd=2, width=900, bg=FRAME_BG, fg=FRAME_FG, height=220,
                  relief=GROOVE)
obj1.place(x=30, y=470)

Label(obj1, text="Father's Name :", font="arial 13", bg=FRAME_BG, fg=FRAME_FG).place(x=30, y=50)
Label(obj1, text="Occupation :", font="arial 13", bg=FRAME_BG, fg=FRAME_FG).place(x=30, y=100)

F_Name = StringVar()
f_entry = Entry(obj1, textvariable=F_Name, width=20, font="arial 10")
...
Label(obj1, text="Mother's Name :", font="arial 13", bg=FRAME_BG, fg=FRAME_FG).place(x=500, y=50)
Label(obj1, text="Occupation :", font="arial 13", bg=FRAME_BG, fg=FRAME_FG).place(x=500, y=100)

M_Name = StringVar()
m_entry = Entry(obj1, textvariable=M_Name, width=20, font="arial 10")
