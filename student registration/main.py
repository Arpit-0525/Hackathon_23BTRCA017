...
# top frames
Label(root, text= "Email: ", width=10 ,height=3 ,bg="#f0687c" ,anchor='e').pack(side=TOP ,fill=X)
...
Label(obj, text= "Skill :" , font="arial 13" , bg= framebg , fg= framefg ).place(x=500, y=150)
...
# Parent Details
obj1 = LabelFrame(root , text= "Parent's Detail :" ,font = 20 , bd=2 , width= 900 , bg= framebg , fg= framefg,height=220 , relief=GROOVE )
